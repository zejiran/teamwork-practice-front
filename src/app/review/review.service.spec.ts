  ...
  it('getPost() should return 10 records', () => {
    ...
    for (let i = 1; i < 11; i++) {
      const review = new Review(
        ...
        faker.datatype.number(),new Route(faker.lorem.sentence(),faker.datatype.number(),new Outing(faker.datatype.number(),faker.lorem.sentence(),faker.datatype.datetime(),faker.lorem.sentence(),faker.datatype.number()))
      );
